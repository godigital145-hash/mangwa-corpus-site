...
export default function EbookDetailViewer({ id, kind = "ebook" }: { id: string; kind?: Kind }) {
  ...
  return (
    <div className="flex flex-col gap-12 py-8 anim-fade-in">

      {/* ── Info ── */}
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 items-start">

        {/* Couverture */}
        <div className="cover-zoom lg:col-span-1 bg-gray-100 aspect-3/4 flex items-center justify-center px-8 py-10">
          {coverUrl
          ...
          <div className="flex flex-wrap items-center gap-3 mt-2">
            ...
            {(pdfFileUrl || mag.price != null) && (
              <a
                ...
                className="press flex items-center gap-2 bg-[#00c853] hover:bg-[#00b548] text-white text-[12px] sm:text-[14px] font-bold"
              >
